...
/**
 * Request to update an existing persistent server.
 * All fields are optional - only specified fields will be updated.
 */
public class UpdatePersistentServerRequest {
    ...
    private UpdatePersistentServerRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdatePersistentServerRequest build() {
            return new UpdatePersistentServerRequest(this);
        }
    }
}
