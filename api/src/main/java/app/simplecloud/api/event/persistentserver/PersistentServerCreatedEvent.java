...
/**
 * Event fired when a persistent server is created.
 */
public interface PersistentServerCreatedEvent {
    ...
    /**
     * Returns the ID of the created persistent server.
     *
    ...
    /**
     * Returns the name of the created persistent server.
     *
